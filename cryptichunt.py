...
with col1:
    st.markdown("<h1 style='color: white;'>221B Wall Street</h1>", unsafe_allow_html=True)

# Add the image to the second column
with col2:
    image_url = "https://i.postimg.cc/PxwsFynz/logos.png"  # Replace with your image URL
